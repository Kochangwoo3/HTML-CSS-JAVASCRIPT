...
function scrollFunction() {
  ...
  if(document.documentElement.scrollTop > 70) {
    if(!header.classList.contains('navbar-fixed')) {
      header.classList.add('navbar-fixedd');
...
function showReviewSlides(n) {
  var i;
  var review_slides = document.getElementsByClassName('review_slide');
  ...
  removeClass(review_slides[reviesSlideIndex], 'hide');
  addClass(review_slides[reviesSlideIndex], 'res-show');
  removeClass(review_slides[reviesSlideIndex+1], 'hide');
  addClass(review_slides[reviesSlideIndex+1], 'show');
  removeClass(review_slides[reviesSlideIndex+2], 'hide');
  addClass(review_slides[reviesSlideIndex+2], 'show');
}
